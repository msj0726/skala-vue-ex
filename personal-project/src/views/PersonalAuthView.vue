  ...
  <div class="auth-page">
    ...
    <main class="auth-shell">
      ...
      <section class="auth-card">
        ...
        <p class="auth-switch"><template v-if="mode === 'signup'">이미 계정이 있나요? <RouterLink to="/login">로그인</RouterLink></template><template v-else>아직 계정이 없나요? <RouterLink to="/signup">회원가입</RouterLink></template></p>
